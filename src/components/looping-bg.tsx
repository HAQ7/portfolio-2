...
export default function LoopingBg({ bgType }: { bgType: LoopingBgType }) {
    ...
    const spaceMove = useTransform(spaceMoveSpring, [0, 1], ["0", "-100vh"]);
            ...
            className={
                ...
                (LoopingBgType.SPACE === bgType
                    ? //  sm:animate-bg-scroll-slow animate-bg-scroll-slow-mobile
                      "bg-[url('../assets/looping-backgrounds/space-bg.png')] sm:animate-bg-scroll-slow animate-bg-scroll-slow-mobile h-[200vh]"
                    : LoopingBgType.STARS_SMALL === bgType
                    ? //  sm:animate-bg-scroll-fast animate-bg-scroll-fast-mobile
                      "bg-[url('../assets/looping-backgrounds/stars-small-bg.png')] sm:animate-bg-scroll-fast animate-bg-scroll-fast-mobile h-[275vh]"
                    : // sm:animate-bg-scroll-fastest animate-bg-scroll-fastest-mobile
                      "bg-[url('../assets/looping-backgrounds/stars-large-bg.png')] sm:animate-bg-scroll-fastest animate-bg-scroll-fastest-mobile h-[325vh]")
            }
        />
    );
}
