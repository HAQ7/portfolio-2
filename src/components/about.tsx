...
import ScrollAnimationSection from "@/components/common/scroll-animation-section";
                    ...
                    <div className="flex flex-col justify-center items-center p-4">
                        <div className="grid gap-10 place-items-center lg:place-items-start">
                            ...
                            <div className="max-w-96 grid gap-3 2xl:text-xl text-lg lg:text-start text-center">
                                <p>
                                    A King Saud University Software Engineering
                                    student passionate in Web development.
                                </p>
                                <p>
                                    Awarded the Dean’s Award for Outstanding
                                    Academic Excellence.
                                </p>
                                <p>
                                    Developed numerous web applications
